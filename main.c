...
void affiche(struct informations footballPlayers[],struct count counter[])
{
    ...
    do
    {
        printf("\n");
        printf("_\n");
        printf("1. Affiche Par ASD  /\\ 2. Affiche Par Age /\\ 3. Affiche Par Poste : \n");
        printf("--- ");
        scanf("%d",&AFM);
        getchar();
    }
    ...
    if(AFM == 2)
    {
     ...
     if(AFM == 3){
            ...
            if(strcmp("gardien",footballPlayers[h].poste) == 0){


                     printf("ID : %d\n",copyAge[h].id);
            printf("Name : %s\n",copyAge[h].nom_prenom);
            printf("numero mailot : %d\n",copyAge[h].numero_maillot);
            ...
            if(strcmp("defenseur",footballPlayers[h].poste) == 0){
            ...
            if(strcmp("millieu",footballPlayers[h].poste) == 0){
            ...
            if(strcmp("attaquant",footballPlayers[h].poste) == 0){
